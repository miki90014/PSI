docker build --no-cache --platform=linux/amd64 -t dockermaniac01/backend-cinema-image-customer:latest .



IMAGE_NAME="dockermaniac01/backend-cinema-image-customer"
